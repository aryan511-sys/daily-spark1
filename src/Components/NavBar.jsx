...
export default class NavBar extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <nav className="navbar navbar-expand-lg fixed-top navbar-dark bg-dark like">
          <div className="container-fluid">
            ...
            <div>
              <label className="theme-switch">
                <input type="checkbox" className="theme-switch__checkbox theame-cla" onClick={toggleMode} />
